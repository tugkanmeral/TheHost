...
export async function aesGcmEncrypt(plaintext, password) {
  ...
  const iv = new Uint8Array([32, 2, 18, 119, 65, 3, 44, 72, 13, 65, 82, 65]); // get 96-bit random iv
...
export async function aesGcmDecrypt(ciphertext, password) {
  ...
  const iv = new Uint8Array([32, 2, 18, 119, 65, 3, 44, 72, 13, 65, 82, 65]); // iv as Uint8Array
